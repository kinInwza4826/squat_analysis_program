    ...
    def save_data_to_csv(self):
        ...
        if file_name:
            try:
                ...
                QMessageBox.information(self.parent(), "Save Successful", f"Data saved to {file_name}")
            except Exception as e:
                QMessageBox.critical(self.parent(), "Save Error", f"Failed to save data: {e}")
    ...
    def save_data_as_graph(self):
        ...
        try:
            ...
            if file_name:
                ...
                QMessageBox.information(self.parent(), "Save Successful", f"Graph saved to {file_name}")
            else:
                QMessageBox.information(self.parent(), "Save Cancelled", "Graph saving cancelled.")

            plt.close(fig)
        
        except Exception as e:
            QMessageBox.critical(self.parent(), "Plotting Error", f"Failed to generate or save graph: {e}")
